...
choosewl:'Выбор без превью'
               ...
               extmodal_image: String() +
				...
				'<div id="redactor_tabs">' +
					...
					'<a href="javascript:void(null);">' + RLANG.choose + '</a>' +
                                        '<a href="javascript:void(null);">' + RLANG.choosewl + '</a>' +
		...
		showImage: function()
		{
			...
			this.modalInit(RLANG.image, this.opts.extmodal_image, 610, callback);
                ...
                imageEdit: function(e)
		{
			...
			this.modalInit(RLANG.image,this.opts.extimgmodal, 380, callback);
